...
function App() {
  ...
  function getAppIcon(appName) {
    switch (appName) {
      ...
      case "PyCharm":
        return (
          <img
            src="./icons/icons8-pycharm-32.png"
            className="app-icon"
          ></img>
        );
      case "GitHubDesktop":
        return (
          <img
            src="./icons/icons8-github-32.png"
            className="app-icon"
          ></img>
        );
      case "OUTLOOK":
        return (
          <img
            src="./icons/icons8-outlook-48.png"
            className="app-icon"
          ></img>
        );
      case "Taskmgr":
        return (
          <img
            src="./icons/icons8-align-bottom-32.png"
            className="app-icon"
          ></img>
        );
      case "explorer":
      ...
      case "Code":
        return (
          <img
            src="./icons/icons8-vs-code-32.png"
            className="app-icon"
          ></img>
        );
      case "devenv":
  ...
  const IconApps = {
    ...
    outlook: (
      <img src="./icons/icons8-outlook-48.png" className="app-icon"></img>
    ),
    Discord: (
